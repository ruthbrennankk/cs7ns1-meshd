echo "Creating Node with Sensor Port $1"
    python3 daemon.py --sensorport $1 </dev/null >/dev/null 2>&1 &
    python3 sensor/sensor_daemon.py --sensortype position --sensorport $1 </dev/null >/dev/null 2>&1 &
    python3 sensor/sensor_daemon.py --sensortype temperature --sensorport $1 </dev/null >/dev/null 2>&1 &
    python3 sensor/sensor_daemon.py --sensortype journey_elapsed --sensorport $1 </dev/null >/dev/null 2>&1 &
