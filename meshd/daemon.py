...
def main():
    ...
    try:
        ...
        print(f'socketname : {protocol_server.server.getsockname()} and hostname : {socket.gethostname()} and addr info {socket.getaddrinfo(socket.gethostname(), protocol_server.server.getsockname())}')
        protocol_manager = ProtocolConnectionManager()
